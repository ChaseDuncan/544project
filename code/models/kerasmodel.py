...
# production
#datapath='datasets/Dataset_iwslt15-vi2en.pkl'
# debug
datapath='datasets/Dataset_iwslt15-vi2en-test.pkl'
...
nmt_model = TranslationModel(params,
                             ...
                             model_name='envi_model',
                             vocabularies=dataset.vocabulary,
                             store_path='trained_models/envi_model/',
                             verbose=True)
...
extra_vars = {'language': 'en',
                            ...
                            'alpha_factor': 0.6,
                            'val':{'references':
                                   dataset.extra_variables['val']['target_text']}
                            }
